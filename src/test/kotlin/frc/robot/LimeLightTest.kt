...
class LimeLightTest {
    ...
    // fun weird() {
    //     // val limelight = Limelight(0.711, 0.24, 40.0) 
    //     // assertEquals(limelight.getPositionAndAddRobot(1.0, -15.0, -40.0, Vector2(1.7, -2.0)).x, 2.69, .05)
    //     // assertEquals(limelight.getPositionAndAddRobot(1.0, -15.0, -40.0, Vector2(1.7, -2.0)).y, -1.965, .05)
    // }
